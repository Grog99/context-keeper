...
You can only CREATE new memories in v1 (no update/delete). To correct an existing memory, save a
new one that references what it supersedes in the body — a human reviewer will reconcile the two.
