> **Archiwum — snapshot roadmapy z 2026-07-23 (v1 domknięte).**
> Zamrożony po ukończeniu całego zakresu v1, przed reconcile roadmapy (przeniesienie
> pluginu Claude Code do backlogu, nowy podział v1.1 / v2+). Żywa roadmapa: [`../roadmap.md`](../roadmap.md).
